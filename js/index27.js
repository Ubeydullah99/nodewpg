...
console.log(`I subtract ${firstNumber}-${secondNumber} and the result is ${firstNumber-secondNumber}`);
...
console.log(`I remainder ${firstNumber}%${secondNumber} and the result is ${firstNumber%secondNumber}`);
